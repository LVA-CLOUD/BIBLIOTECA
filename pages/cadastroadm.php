...
include_once("../config/verificar_adm.php");
...
// Total usuários
$resUsuarios = $conn->query("SELECT COUNT(*) as total FROM registro");
$rowUsuarios = $resUsuarios->fetch_assoc();
$totalUsuarios = (int)($rowUsuarios['total'] ?? 0);

// Funcionários
$resFuncionarios = $conn->query("SELECT COUNT(*) as total FROM registro WHERE id_nivel = 2");
$rowFunc = $resFuncionarios->fetch_assoc();
$totalFuncionarios = (int)($rowFunc['total'] ?? 0);

// Administradores
$resAdmins = $conn->query("SELECT COUNT(*) as total FROM registro WHERE id_nivel = 3");
$rowAdm = $resAdmins->fetch_assoc();
$totalAdmins = (int)($rowAdm['total'] ?? 0);
...
<title>Painel Administrativo - Biblioteca Athenas</title>
...
<nav class="navbar-vertical">
    ...
    <div class="navbar-vertical-content">
        ...
        <ul class="nav flex-column px-2">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="dashboardadm.php">
                    <i class="fas fa-chart-pie"></i> Dashboard ADM
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="acervofuncionario.php">
                    <i class="fas fa-book"></i> Gerenciar Acervo
                </a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link" href="cadastroadm.php">
                    <i class="fas fa-user-shield"></i> Cadastro ADM
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="cadastro.php">
                    <i class="fas fa-user-plus"></i> Cadastro Funcionário
                </a>
            </li>
...
<main class="content">
    ...
    <div class="row justify-content-between align-items-center mb-4">
        ...
        <div class="col-auto">
            <div class="text-muted fw-semi-bold">
                <?php echo date('d/m/Y'); ?>
            </div>
        </div>
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            ...
            <div class="card-stats">
                ...
                <span class="display-stats text-warning">
                    <?= $totalAtivos ?>
                </span>
        ...
        <div class="col-md-4">
            ...
            <div class="card-stats">
                ...
                <span class="display-stats text-success">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-md-4">
            ...
            <div class="card-stats">
                ...
                <span class="display-stats text-primary">
                    <?= $totalUsuarios ?>
                </span>
        ...
        <div class="col-md-4">
            ...
            <div class="card-stats">
                ...
                <span class="display-stats text-info">
                    <?= $totalFuncionarios ?>
                </span>
        ...
        <div class="col-md-4">
            ...
            <div class="card-stats">
                ...
                <span class="display-stats text-danger">
                    <?= $totalAdmins ?>
                </span>
            ...
            <div class="card bg-primary text-white border-0 h-100">
                ...
                <div class="card-body p-4">
                    ...
                    <p class="small opacity-75">
                        ...
                        Aqui o administrador possui acesso total ao sistema,
                        gerenciamento de usuários, funcionários,
                    ...
                    <a href="cadastroadm.php" class="btn btn-sm btn-light w-100 fw-bold">
                        Acessar Cadastro ADM
                    </a>
