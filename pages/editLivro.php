...
// 2. Busca fotos do livro (Supondo tabela 'fotos_livros')
...
<body class="bg-light p-4">
    ...
    <div class="container bg-white p-4 shadow-sm rounded">
        ...
        <form action="../config/processar_edit_livro.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card p-3 border-danger">
                        ...
                        <p class="small">A exclusão não pode ser desfeita.</p>
            ...
            <h4><i class="fas fa-images"></i> Gerenciar Fotos</h4>
            <div class="mb-3">
                <label>Adicionar Novas Fotos (pode selecionar várias)</label>
                ...
                <?php if ($fotos->num_rows > 0): ?>
                    <?php while ($f = $fotos->fetch_assoc()): ?>
                        <div class="foto-card <?= $f['principal'] ? 'principal' : '' ?>">
                            <?php if ($f['principal']): ?>
                                <span class="badge bg-success badge-principal">Principal</span>
                            <?php endif; ?>

                            <img src="../assets/img/livro_id/<?= $id_livro ?>/<?= $f['caminho'] ?>" class="img-edit">

                            <div class="mt-2 d-flex justify-content-between">
                                <a href="../config/foto_operacoes.php?op=main&id_foto=<?= $f['id_livro_img'] ?>&id_livro=<?= $id_livro ?>"
                                    class="btn btn-sm btn-outline-primary">
                                    <i class="fas fa-star"></i>
                                </a>

                                <a href="../config/foto_operacoes.php?op=del&id_foto=<?= $f['id_livro_img'] ?>&id_livro=<?= $id_livro ?>"
                                    class="btn btn-sm btn-outline-danger"
                                    onclick="return confirm('Excluir foto?')">
